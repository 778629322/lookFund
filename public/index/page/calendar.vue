<!--  -->
<template>
    <div class="calendar" ref="calendar" :class="{ Y: type == 'Y', M: type == 'M' }">
        ...
        <div class="box">
            <div class="years" v-for="Y in years" :key="Y">
                ...
                <div class="months" v-for="M in 12" :key="Y + '-' + M" @click="lookM(Y, M, $event)">
                    <div class="list">
                        <div class="item" v-for="day in getSpace(Y, M)" :key="-day"></div>
                        <div class="item day" v-for="day in getDay(Y, M)" :key="day" :style="
                getRgb(
                  optionalChaining(
                    calendar,
